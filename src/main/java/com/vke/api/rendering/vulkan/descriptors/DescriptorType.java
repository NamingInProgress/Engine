...
public enum DescriptorType implements IntEnum {
    ...
    public static DescriptorType fromBaseType(DescriptorCategory rt, boolean isDynamic) {
        var v = switch (rt) {
            case UNIFORM_BUFFER -> isDynamic ? UNIFORM_BUFFER_DYNAMIC : UNIFORM_BUFFER;
            case STORAGE_BUFFER -> isDynamic ? STORAGE_BUFFER_DYNAMIC : STORAGE_BUFFER;
            ...
            case UNIFORM_CONSTANT -> UNIFORM_BUFFER;
