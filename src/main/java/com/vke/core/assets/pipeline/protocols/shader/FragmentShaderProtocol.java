...
public class FragmentShaderProtocol implements AssetProtocol<Shader> {

    @Override
    public String getProtocolName() {
        return Protocols.FRAGSHADER;
    }
    ...
    public Loader getLoader() {
        return new FragmentShaderLoader();
    }
    ...
    public static class FragmentShaderLoader implements Loader {
        @Override
