...
public class TextRendererPass1DriverBezier extends PipelineDriver {

    private final BufferResource matrices;

    private MatrixStack matrixStack;

    public TextRendererPass1DriverBezier(RenderSystem sys) {
        super(sys, R.pipelines.get("vke:font_pass_1_bezier.pipeline.json"));
